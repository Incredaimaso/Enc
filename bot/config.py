...
class Config:
    def __init__(self):
        try:
            ...
            self.C_LINK = config("C_LINK", default="@Anime_Piras")
            ...
            self.QBIT_PORT = config("QBIT_PORT", default=8080, cast=int)
            self.QBIT_PORT2 = config("QBIT_PORT2", default=8080, cast=int)
